<div class="modal fade" id="city_details" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 mb-3">
                            <div class="input-block ">
                                ...
                                <select class="form-control form-small select" name="idState" id="idState">
                                    <option>Select State</option>
                                    @foreach ($regiones as $st)
                                        <option value="{{ $st->id }}">{{ $st->name }}
                                        </option>
                                    @endforeach
                                </select>
